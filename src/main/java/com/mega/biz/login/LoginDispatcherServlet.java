...
//        import java.io.IOException;
//
//public class LoginDispatcherServlet {
//
//
//    //모든요청을 얘가 다 받는다-> 요청을 처리(헨들매핑클레스)하고 포워딩(뷰리절브)한다
//    @WebServlet("/login.do")
//    public class DispatcherServlet extends HttpServlet {
//        private static final long serialVersionUID = 1L;
//        private HandlerMapping handlerMapping;//컨트롤러 목록관리 클레스
//        private ViewResolver viewResolver;//퍼워딩 정보 완성시켜줌
//
//
...
//            String path = uri.substring(uri.lastIndexOf("/"));
//
//            Controller ctrl = handlerMapping.getController(path);//uri을 이용해서 컨트롤러를 뽑아올거다
//            //handlerMapping정보를 이용해서 컨트롤러를 뽑아올거다
//            //요청에 대한 컨트롤러를 가져옴
//
//            if (ctrl == null) {
